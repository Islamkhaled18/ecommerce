                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="group-reviews">
                                                                ...
                                                                <div class="info-stock ml-auto">
                                                                    <label class="control-label">{{ trans('dashboard.availablilty') }}:</label>
                                                            ...
                                                            <form
                                                                ...
                                                                <a class="add-to-cart cart-addition" data-product-id="{{$product -> id}}" data-product-slug="{{$product -> slug}}" href="#"
                                                                   data-button-action="add-to-cart"><i
                                                                        class="novicon-cart"></i><span>{{ trans('front.add_to_card') }}</span></a>
                                                            </form>
...
@section('scripts')
    <script>
        ...
        $(document).on('click','.cart-addition',function(){
            e.preventDefault();
            $.ajax({
                type:'post',
