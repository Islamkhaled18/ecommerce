                ...
                <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                        <a itemprop="item" href="36-mini-speaker.html">
                            <span itemprop="name">{{ trans('front.favourite_list') }}</span>
                        </a>
            ...
            <div id="content-wrapper" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <section id="main">
                    <div class="block-category hidden-sm-down">
                        <h1 class="h1">{{ trans('front.favourite_list') }}</h1>
                    </div>
                    <section id="products">
                            ...
                            <div id="js-product-list-top" class="row products-selection">
                                <div class="col-md-6 col-xs-6">
                                    ...
                                    <div class="hidden-sm-down total-products">
                                        <p>{{ trans('front.there_are') }} {{count($products) ?? '0'}} {{ trans('dashboard.products') }}.</p>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-6">
                                    <div class="d-flex sort-by-row justify-content-end">

                                        <span class="hidden-sm-down sort-by">{{ trans('front.sort_by') }}:</span>
                                        <div class="products-sort-order dropdown">
                                            <a class="select-title" rel="nofollow" data-toggle="dropdown"
                                               aria-haspopup="true" aria-expanded="false">
                                                <span>{{ trans('front.relevance') }}</span>
                                            ...
                                            <div class="dropdown-menu">
                                                <a rel="nofollow"
                                                   ...
                                                   {{ trans('front.relevance') }}
                                                </a>
                                                <a rel="nofollow"
                                                   href="36-mini-speaker-28.html?home=home_3&amp;order=product.name.asc"
                                                   class="select-list js-search-link">
                                                    {{ trans('front.name') }}, {{ trans('front.a') }} {{ trans('front.to') }} {{ trans('front.z') }}
                                                </a>
                                                <a rel="nofollow"
                                                   href="36-mini-speaker-29.html?home=home_3&amp;order=product.name.desc"
                                                   class="select-list js-search-link">
                                                   {{ trans('front.name') }}, {{ trans('front.z') }} {{ trans('front.to') }} {{ trans('front.a') }}
                                                </a>
                                                        ...
                                                        <div class="product-groups">
                                                            ...
                                                            <div class="group-reviews">
                                                                ...
                                                                <div class="info-stock ml-auto">
                                                                    <label class="control-label">{{ trans('front.availability') }}:</label>
                                                        ...
                                                        <div class="product-buttons d-flex justify-content-center"
                                                            ...
                                                            <a class="removeFromWishlist addToWishlist  wishlistProd_22" href="#"
                                                               data-product-id="{{$product -> id}}">
                                                                ...
                                                                <span>{{ trans('front.remove_from_wishlist') }}</span>
                                                            </a>
                                                            <a href="#" class="quick-view hidden-sm-down"
                                                               data-product-id="{{$product -> id}}">
                                                                <i class="fa fa-search"></i><span>{{ trans('front.quick_view') }}</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
