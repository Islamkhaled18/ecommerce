                                            ...
                                            <form action=""
                                                ...
                                                <div class="productdetail-right col-12 col-lg-6 col-md-6">
                                                    ...
                                                    <div class="in_border end">
                                                        ...
                                                        <div class="sku">
                                                            <label class="control-label">{{ trans('dashboard.sku') }}:</label>
                                                            <span itemprop="sku"
                                                                  content="demo_1">{{$product -> sku ?? '--'}}</span>
                                                        </div>
                                                        <div class="pro-cate">
                                                            <label class="control-label">{{ trans('dashboard.categories') }}:</label>
                                                        ...
                                                        <div class="pro-tag">
                                                            <label class="control-label">{{ trans('dashboard.tags') }}:</label>
                                                            @isset($product ->tags)
                                                                <div>
                                                    ...
                                                    <div id="_desktop_productcart_detail">
                                                        <div class="product-add-to-cart in_border">
                                                            ...
                                                            <div id="product-availability" class="info-stock mt-20">
                                                                <label class="control-label">{{ trans('dashboard.availability') }}:</label>
                                                ...
                                                <div class="productdetail-left col-12 col-lg-6 col-md-6">
                                                    ...
                                                    <div class="product-quantity">
                                                        <span class="control-label">{{ trans('dashboard.quantity') }} : </span>
                                                        <div class="qty">
                            ...
                            <div class="row">
                                <div class="tabs col-lg-9 col-md-7 ">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" aria-expanded="true" href="#product-details">{{ trans('dashboard.details') }}</a>
                                        </li>
                                        <li class="nav-item">
