                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('admin.brands')}}"> {{ trans('dashboard.tags') }} </a>
                            </li>
                            <li class="breadcrumb-item active"> {{ trans('dashboard.edit') }} - {{$tag ->name}}
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">{{ trans('dashboard.edit') }} - {{$tag ->name}}</h4>
                                ...
                                <div class="card-body">
                                    <form class="form"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <h4 class="form-section"><i class="ft-home"></i>{{ trans('dashboard.edit') }} - {{$tag ->name}}</h4>
                                            <div class="row">
                                                <div class="col-md-6">
