                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.brands')}}">{{ trans('dashboard.brands') }}</a>
                                </li>
                                <li class="breadcrumb-item active"> {{ trans('dashboard.edit') }} - {{$brand ->name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{ trans('dashboard.edit_brand') }} </h4>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src="{{$brand  ->image}}"
                                                        class="rounded-circle  height-250" alt="{{trans('dashboard.image')}} ">
                                                </div>
                                            </div>
                                            <div class="form-group">
