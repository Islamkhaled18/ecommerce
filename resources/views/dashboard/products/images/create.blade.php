                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.products') }}">
                                    {{ trans('dashboard.product') }}  </a>
                                </li>
                                <li class="breadcrumb-item active"> {{ trans('dashboard.product_images') }} 
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{ trans('dashboard.add_new_product_images') }}  </h4>
                                    ...
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>{{ trans('dashboard.product_images') }} </h4>
