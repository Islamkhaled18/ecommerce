                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ trans('dashboard.stock') }} </a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ trans('dashboard.sku') }}
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ trans('dashboard.follow_product') }}
                                                            </label>
                                                            <select name="manage_stock" class="select2 form-control" id="manageStock">
                                                                <optgroup label="{{trans('dashboard.choose_availability')}}">
                                                                    <option value="1">{{ trans('dashboard.follow') }}</option>
                                                                    <option value="0" selected>{{ trans('dashboard.un_follow') }}</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('manage_stock')
                                                            <span class="text-danger"> {{$message}}</span>
                                                ...
                                                <div class="row">
                                                  <!-- QTY  -->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ trans('dashboard.status') }}
                                                            </label>
                                                            <select name="in_stock" class="select2 form-control" >
                                                                <optgroup label="من فضلك أختر  ">
                                                                    ...
                                                                    <option value="0">{{ trans('dashboard.un_available') }}</option>
                                                                </optgroup>
                                                            </select>
                                                            @error('in_stock')
                                                            <span class="text-danger"> {{$message}}</span>
