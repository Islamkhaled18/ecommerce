                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ trans('dashboard.add_new_product') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{ trans('dashboard.add_new_product') }}</h4>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ trans('dashboard.product_detilas') }}
                                                            </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{ trans('dashboard.short_product_detilas') }}
                                                            </label>
                                                ...
                                                <div class="row" >
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ trans('dashboard.choose_tags') }}
                                                            </label>
                                                            <select name="tags[]" class="select2 form-control" multiple>
                                                                <optgroup label="{{ trans('dashboard.choose_tags') }}">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="projectinput1">{{ trans('dashboard.choose_brand') }}
                                                            </label>
                                                            <select name="brand_id" class="select2 form-control">
                                                                <optgroup label="{{ trans('dashboard.choose_brand') }}">
