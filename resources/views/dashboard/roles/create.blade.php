                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.roles.index')}}">
                                    {{ trans('dashboard.permissions') }} </a>
                                </li>
                                <li class="breadcrumb-item active"> {{ trans('dashboard.add_new_permission') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{ trans('dashboard.add_new_permission') }}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            @csrf
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> {{ trans('dashboard.permissions') }} </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
