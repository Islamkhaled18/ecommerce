                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ trans('dashboard.shipping_methods') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{ trans('dashboard.edit_shipping_methods') }}  </h4>
                                        ...
                                        <form class="form" action="{{ route('update.shippings.methods',$shippingMethod->id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> {{ trans('dashboard.shipping_cost') }} </label>
                                                            <input type="number" value="{{$shippingMethod -> plain_value}}" id="plain_value"
                                                                class="form-control"
                                                                placeholder=" {{ trans('dashboard.shipping_cost') }} "
                                                                name="plain_value">
                                                            @error("plain_value")
                                                            <span class="text-danger">{{$message}}</span>
                                                            @enderror
